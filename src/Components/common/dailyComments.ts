...
export const commentAboutClothesDetail: {
  ...
  cold: {
    description:
      '조금 추운 날씨예요. 도톰한 외투를 입는게 좋겠어요! 도톰한 후리스 같은 외투는 어떨까요? 추운 날씨에 가장 중요한 목을 보호하기위해 목 끝까지 잠그고 나가볼까요?  ',
  },
  superCold: {
    description:
      '후덜덜 추운날씨예요. 두꺼운 패딩이나 코트를 꼭 입는게 좋겠어요. 발이 시리면 패딩을 입어도 몸이 시릴 수 있으니 부츠나 털신발을 신어보는건 어떨까요?',
  },
  freeze: {
    description:
